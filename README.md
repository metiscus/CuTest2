# CuTest2
Fork / Continuation of CuTest from http://sourceforge.net/p/cutest

The original CuTest had not been updated since 2009 so I have taken the latest version and placed it on github.

If the original project becomes active again, I will work to integrate any changes made in this fork back to the original.
